...
def start_server(host='127.0.0.1', port=6379):
    ...
    radish_colorized = f"""
    {RED}RRRR{RESET}   {GREEN}AAA{RESET}   {MAGENTA}DDDD{RESET}   {WHITE}III{RESET}  {YELLOW}SSSS{RESET}  {GREEN}H   H{RESET}
    {RED}R   R{RESET} {GREEN}A   A{RESET}  {MAGENTA}D   D{RESET}   {WHITE}I{RESET}  {YELLOW}S    {RESET}  {GREEN}H   H{RESET}
    {RED}RRRR{RESET}  {GREEN}AAAAA{RESET}  {MAGENTA}D   D{RESET}   {WHITE}I{RESET}   {YELLOW}SSS {RESET}  {GREEN}HHHHH{RESET}
    {RED}R R{RESET}   {GREEN}A   A{RESET}  {MAGENTA}D   D{RESET}   {WHITE}I{RESET}      {YELLOW}S{RESET}  {GREEN}H   H{RESET}
    {RED}R  RR{RESET} {GREEN}A   A{RESET}  {MAGENTA}DDDD{RESET}   {WHITE}III{RESET}  {YELLOW}SSSS{RESET}  {GREEN}H   H{RESET}
    """
